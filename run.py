...
navbar = dbc.NavbarSimple(
    brand='Twitter Hate Speech Detector',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Nayomi Chibana', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:nchibana@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/nchibana'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/nchibana/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/nchibana'), 
                ], 
                className='lead'
            )
        )
